...
export type UserGetPayload<Args extends $SelectIncludeOmit<$Schema, 'User', true>> =
...
export type PostGetPayload<Args extends $SelectIncludeOmit<$Schema, 'Post', true>> =
  $SimplifiedModelResult<$Schema, 'Post', Args>
...
export type CategoryGetPayload<Args extends $SelectIncludeOmit<$Schema, 'Category', true>> =
  $SimplifiedModelResult<$Schema, 'Category', Args>
