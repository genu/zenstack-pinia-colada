...
import { getKey, makeUrl, marshal, unmarshal, fetcher, QUERY_KEY_PREFIX, DEFAULT_QUERY_ENDPOINT } from '../src/utils/common';
...
describe('Pinia Colada Client Tests', () => {
    ...
    describe('useModelQueries', () => {
        ...
        it('should throw error for non-existent model', () => {
            expect(() => useModelQueries(schema, 'NonExistent' as any)).toThrow('Model "NonExistent" not found in schema');
        });
...
describe('Utility Functions', () => {
    ...
    describe('fetcher', () => {
        ...
        it('should pass request options to fetch', async () => {
            ...
            await fetcher('/api/test', { method: 'POST', headers: { 'Content-Type': 'application/json' } });
